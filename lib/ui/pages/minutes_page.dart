...
class _MinutesPageState extends State<MinutesPage> {
  ...
  Future<void> loadData() async {
    ...
    _listModel = [for (final item in j['minutes']['sections']) MinutesModel.fromJson(item)];
    setState(() {});
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Минуты', style: kTextStyle(fontWeight: FontWeight.w600),),
          centerTitle: true,
        ),
        body: TabBarView(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 8),
                        child: Text('Количество минут:', style: kTextStyle(color: textGreyDark, size: 12, fontWeight: FontWeight.w500),),
                      ),
                    ),
